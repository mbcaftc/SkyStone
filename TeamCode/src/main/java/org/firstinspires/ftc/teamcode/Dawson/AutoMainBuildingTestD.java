...
public abstract class AutoMainBuildingTestD extends LinearOpMode {
    ...
    public void goToSkystonesInner(WoodBot Bot, String Alliance) {
        if (Alliance == "Red") {
...
*/
    ...
    public void hardCodeVuforia ( WoodBot Bot, String Alliance) {
        if (skystonePos == 1){
    ...
    public void orientToDropStone(WoodBot Bot, String Alliance) {
        if (Alliance == "Red") {
